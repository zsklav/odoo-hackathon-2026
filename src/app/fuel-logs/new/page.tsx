...
import type { FuelLogVehicle } from "@/types/fuel-log";
...
export default function NewFuelLogPage() {
  ...
  function validate(): string | null {
    ...
    if (!liters || !Number.isFinite(litersValue) || litersValue <= 0) {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    router.push(`/fuel-logs/${result.id}`);
  }
      ...
      <div className="mx-auto flex w-full max-w-2xl flex-col gap-6 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="rounded-lg border border-dashed border-border py-16 text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Fuel logs need a vehicle to exist before they can be recorded.
          </p>
  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-6 px-4 py-8 sm:px-6 lg:px-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xl">Add Fuel Log</CardTitle>
        </CardHeader>
        <CardContent>
          {errorMessage && (
