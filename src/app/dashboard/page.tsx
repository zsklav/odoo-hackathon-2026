...
import { VehiclePill } from './_components/vehicle-pill'
...
export default async function DashboardPage({
  ...
  // Filters only apply to the vehicle table below — the KPI cards stay a global
  // fleet snapshot (the "at a glance" numbers).
  const vehicleWhere = {
  ...
  try {
    ...
    loadError =
      'Could not load dashboard data. Ensure the DB schema is migrated (via DIRECT_URL :5432) and seeded, and DATABASE_URL / DIRECT_URL are set in .env.'
  }
